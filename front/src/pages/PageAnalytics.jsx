      ...
      <div className="flex-1 pl-[100px]">
        ...
        <div className="w-full mx-auto mt-10 px-4 sm:px-6 lg:px-8" ref={reportRef}>
          ...
          <div className="bg-white rounded-lg shadow mb-8">
            <div className="px-6 py-5 border-b border-gray-200">
              <h2 className="text-lg font-medium text-violet-700">Integração com Google Analytics</h2>
            </div>
            <div className="p-6">
              ...
              <Link
                ...
                className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-violet-700 hover:bg-violet-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-900"
              >
